...
| Question                                             | Options                                   |
| ---------------------------------------------------- | ----------------------------------------- |
| How often do we meet?                                | Weekly / biweekly / monthly               |
| How long?                                            | 1.5h / 2h / 2.5h                          |
| Where?                                               | Here / rotating / online                  |
| How do we share notes?                               | This site / are.na / email                |
| How do we want to make decisions?                    | Consensus / voting / other                |
| How do we want to communicate between sessions?      | Google Chat / email / other               |
| How do we want to document our work?                 | This site / are.na / other                |
| How do we want to share our work outside the group?  | This site / social media / other          |
| How do we want to handle disagreements or conflicts? | Open discussion / mediation / other       |
| How do we want to invite new members?                | Open invitation / referral / other        |
| How to create a welcoming and inclusive environment? | Guidelines / open discussion / other      |
| How to credit the use of AI in our work?             | Acknowledgment / separate section / other |
